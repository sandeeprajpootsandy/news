...
<!-- stylesheet -->
	...
	<div class="container">
		...
		<!-- //btm-wthree-left -->
            ...
            {{Form::open(array('url'=>'/postcomment') )}}
					...
					<div class="form-group">
						{{Form::label('COMMENT','',['class'=>'text-body'])}}
						{{Form::textarea('cmt','',['placeholder'=>'Hey... say something!','class'=>'form-control','required'])}}
		...
		{{Form::open(array('url'=>'/postreply'))}}
				
				<div class="container">
					{{Form::label('Reply','',['class'=>'text-dark'])}}
					{{Form::text('ply','',['placeholder'=>'Write something','class'=>'form-control','required'])}}
					<label id="lnerror" class=""></label>
					{{Form::hidden('uid',"$uid")}} 
					{{Form::hidden('nid',"$nid")}}
